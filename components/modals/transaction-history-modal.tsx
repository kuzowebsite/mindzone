            ...
            <div className="space-y-2 sm:space-y-3 py-2 sm:py-4">
              {loading ? (
                ...
                filteredTransactions.map((transaction) => (
                  <Card
                    key={transaction.id}
                    className="gaming-card border-amber-500/20 hover:border-amber-500/40 transition-colors cursor-pointer group"
                    ...
                    <CardContent className="p-3 sm:p-4">
                      <div className="flex items-start sm:items-center justify-between gap-3">
                        ...
                        <div className="text-right flex-shrink-0 flex items-center gap-2">
                          <div>
                            <p
                              className={`text-sm sm:text-lg font-bold ${getAmountColor(transaction.type, transaction)}`}
                            >
                          ...
                          <Eye className="h-4 w-4 text-gray-400 group-hover:text-amber-400 transition-colors" />
                        </div>
                      </div>
                    </CardContent>
                  </Card>
